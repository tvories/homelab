...
variable "domain_admin_user" {
  description = "Domain join user account"
}
...
variable "vsphere_k8_win_nodes" {
  description = "Number of Windows K8 Nodes"
}
...
variable "vsphere_vm_name_k8_win" {
  description = "K8 Win Node VM name"
}
...
variable "vsphere_ip4v_address_win_minion_host" {
  description = "K8 Win Node IP"
}
